...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Display = __webpack_require__(172);

	var _Display2 = _interopRequireDefault(_Display);

	var _NumberPad = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./main.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./main.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// exports
	exports.locals = {
		"app": "main__app___QHEFg",
		"appInr": "main__appInr___V759C"
	};
	  ...
	  _createClass(NumberPad, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          { className: _NumberPad2.default.numberPad },
	          numBtn.map(function (num, i) {
	            return _react2.default.createElement(
	              'li',
	              { className: _NumberPad2.default.numberPad__item, onClick: _this2.numInput, 'data-num': num, key: i },
	              num
	            );
	          }),
	          _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./NumberPad.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./NumberPad.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
